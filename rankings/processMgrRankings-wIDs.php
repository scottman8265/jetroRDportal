...
function getRankingArray($rankingQry, $branchInfo, $positions, $regionals, $auditInfo) {
	...
	foreach ($rankingQry as $data) {
		...
		if (!isset($rankingArr[$regionCode][$regionalName][$brName])) {
			$rankingArr[$regionCode][$regionalName][$brNum . " - " . $brName][$dept][] =
			[
				'Position' => $pos,
				'Team Member' => $name,
				'Score'     => 'N/A',
			...
			[
				...
				'tenureObj'  => 'N/A',
				'lastAudit'  => 'N/A'
			],  '126'  => ['name'       => 'N/A', 'totalScore' => 'N/A',  'tenure'     => 'N/A', 'tenureObj'  => 'N/A', 'lastAudit'  => 'N/A'], '126a' => ['name'       => 'N/A', 'totalScore' => 'N/A', 'tenure'     => 'N/A',
  'tenureObj'  => 'N/A', 'lastAudit'  => 'N/A'],
  '126b' => ['name'=> 'N/A', 'totalScore' => 'N/A',  'tenure'=> 'N/A','tenureObj'  => 'N/A', 'lastAudit'  => 'N/A'],
'151'  => ['name'=> 'N/A',
 'totalScore' => 'N/A',
 'tenure'     => 'N/A',
'tenureObj'  => 'N/A',
